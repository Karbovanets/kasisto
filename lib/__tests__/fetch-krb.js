...
const URL_BASE = "http://108.61.198.115:32348";
...
describe('accept payment', () => {
  ...
  it('creates an incoming payment', () => {
    return requestPayment(URL, null, null, 1e12).then(({ address, paymentId, integratedAddress, height }) => {
  ...
  it('fetches a barcode URI', () => {
    return requestPayment(URL, null, null, 1e12).then(({ makeUri }) => {
  ...
  describe('onFulfilled', () => {
    ...
    it('has a nice api', () => {
      return requestPayment(URL, null, null).then(
    ...
    it('can be cancelled', () => {
      return requestPayment(URL, null, null, 1e12).then(({ onFulfilled, cancel }) => {
    ...
    it('resolves when the payment is complete', () => {
      return requestPayment(URL, null, null, 1e12, 0).then(({ onFulfilled, cancel }) =>

...
Go to 
http://localhost:8000/#/settings to set your karbo address. Set Wallet URL  http://www.karbo.club/api and karbo address must be generate on  http://www.karbo.club/
